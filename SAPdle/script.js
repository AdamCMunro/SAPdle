    ...
    if (petCol[5 - x].classList.contains("hidden") && petCol[5 - x].classList.contains("active")) {
        ...
        if (pets[x - 1].name != null) {
            ...
            if (pets[x - 1].food != null) {
                ...
                if (pets[x-1].name == "Penguin" || pets[x-1].name == "Jellyfish" || pets[x-1].name == "Crane" || pets[x-1].name == "Lion" || pets[x-1].name == "Racoon" || pets[x-1].name == "Doberman" || pets[x-1].name == "Gorilla" || pets[x-1].name == "Flamingo" || pets[x-1].name == "Wolf" || pets[x-1].name == "Deer") {
